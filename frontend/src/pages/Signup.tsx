...
function Signup() {
  ...
  // Deklarasikan tipe hasil dari hook useSignup
  const { userr, loading, error } = useSignup();

  // Menambahkan tipe untuk event parameter
  function handleSubmit(e: FormEvent<HTMLFormElement>) {
    e.preventDefault();
    userr(email, password); // Pastikan userr adalah fungsi yang menerima email dan password
  }
